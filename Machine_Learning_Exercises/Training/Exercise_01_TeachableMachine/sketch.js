...
let modelURL = "https://teachablemachine.withgoogle.com/models/QFCOdqDuu/"
let cropedVideo;
...
function draw() {
  ...
  if (label == "bottle" && confidence > 90) {
    x++;
  }
  if (label == "cup" && confidence > 90) {
    x--;
  }
  if (label == "arduino" && confidence > 90) {
    y--;
  }
  rect(x, y, 100, 100);
}
