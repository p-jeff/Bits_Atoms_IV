...
function setup() {
  ...
  classificationText = 'waiting to train model';
...
function gotResults(error, results) {
  //  Log output
  classificationText = results[0].label+" "+floor(results[0].confidence * 100)+"%";
  // Classify again
  classify();
}
...
function draw() {
  ...
  text(classificationText, width*0.5, height*0.1)
}